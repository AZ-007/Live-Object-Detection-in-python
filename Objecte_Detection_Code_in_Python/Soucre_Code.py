...
prototxt_path='Pretrined_model\MobileNetSSD_deploy.prototxt'
model_path = 'Pretrined_model\MobileNetSSD_deploy.caffemodel'
min_confidence =0.2
classes= ['background',
...
cap = cv2.VideoCapture(0)# for live camer input (0) 
